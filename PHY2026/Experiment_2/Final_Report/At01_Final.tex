...
\begin{figure}[h]
\centering
\includegraphics[scale=0.8]{"Red_Plot".pdf}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.8]{"Blue_Plot".pdf}
...
% When setting up the circuit, the distance between the Helmoholtz coils was slightly different to that of the radius of a coil. This was because the ESR basic unit had to fit between the two coils in order to ensure that the DPPH was central in position as shown in \figref{fig:electron_picture}. Therefore, the actual measured value of $r$ for use in  \eqref{eq:magnetic-equation} was now $7.5 \pm1.0$ cm. The large error was used to ensure that had the value of $6.75$cm in the range and to accomodate parallax error when setting up the coils. This was all noted and used later in \eqref{eq:magnetic-equation} when determining generated the magnetic fields. 
